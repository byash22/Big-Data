...
P1.add(Bytes.toBytes("OfficialDetails"),	Bytes.toBytes("Name"),		Bytes.toBytes("Snehu"));
...
P1.add(Bytes.toBytes("PersonalDetails"),	Bytes.toBytes("Age"),		Bytes.toBytes("22"));
P1.add(Bytes.toBytes("PersonalDetails"),	Bytes.toBytes("City"),		Bytes.toBytes("Delhi"));
hTable.put(P1);
...
P2.add(Bytes.toBytes("OfficialDetails"),	Bytes.toBytes("Name"),		Bytes.toBytes("Aries"));
...
P2.add(Bytes.toBytes("PersonalDetails"),	Bytes.toBytes("Age"),		Bytes.toBytes("21"));
P2.add(Bytes.toBytes("PersonalDetails"),	Bytes.toBytes("City"),		Bytes.toBytes("Mumbai"));
hTable.put(P2);
...
P3.add(Bytes.toBytes("OfficialDetails"),	Bytes.toBytes("Name"),		Bytes.toBytes("hanu"));
...
P3.add(Bytes.toBytes("PersonalDetails"),	Bytes.toBytes("Age"),		Bytes.toBytes("24"));
P3.add(Bytes.toBytes("PersonalDetails"),	Bytes.toBytes("City"),		Bytes.toBytes("Chandigarh"));
hTable.put(P3);
...
P4.add(Bytes.toBytes("OfficialDetails"),	Bytes.toBytes("Name"),		Bytes.toBytes("Kartik"));
...
P4.add(Bytes.toBytes("PersonalDetails"),	Bytes.toBytes("Age"),		Bytes.toBytes("22"));
...
P5.add(Bytes.toBytes("OfficialDetails"),	Bytes.toBytes("Name"),		Bytes.toBytes("Ritu"));
...
P5.add(Bytes.toBytes("PersonalDetails"),	Bytes.toBytes("City"),		Bytes.toBytes("Jagadhri"));
hTable.put(P5);
